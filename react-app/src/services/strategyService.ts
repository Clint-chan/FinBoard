...
export function getStrategyTypeColor(type: string): { bg: string; text: string; border: string } {
  const colors: Record<string, { bg: string; text: string; border: string }> = {
    price: { bg: 'bg-green-50', text: 'text-green-700', border: 'border-green-100' },
    sector_arb: { bg: 'bg-blue-50', text: 'text-blue-700', border: 'border-blue-100' },
    ah_premium: { bg: 'bg-purple-50', text: 'text-purple-700', border: 'border-purple-100' },
    fake_breakout: { bg: 'bg-orange-50', text: 'text-orange-700', border: 'border-orange-100' }
  }
  return colors[type] || { bg: 'bg-gray-50', text: 'text-gray-700', border: 'border-gray-100' }
}
